...
function renderInventoryTab() {
  ...
  <div class="space-y-6">
    ...
    ${stockSaveMessage ? `<div class="bg-green-100 text-green-700 p-4 rounded-lg font-medium shadow-sm">${escH(stockSaveMessage)}</div>` : ''}

    ${Object.entries(inventoryCategories).map(([catName, items], idx) => `
